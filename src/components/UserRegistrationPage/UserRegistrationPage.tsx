...
export class UserRegistrationPage extends React.Component {
          ...
          <Col md={ { span: 8, offset: 2 } }>
            <Card>
                <Card.Body>
                   ...
                   {
                         (this.state.isRegistationComplete=== false) ?//ako je uslov ispunjen
                          this.renderForm() : //pozvati ovaj blok
                          this.renderRegistrationCompleteMessage()//u suprotnom ovaj
                          }
                    </>            
    ...
    private renderForm(){
        ...
        <Alert variant="danger" //ako ovaj state ima vrednost-prikazi ga,ako nema sakrij(display none)
    ...
    private doRegister(){
      ...
      .then((res: ApiResponse) => {
          ...
          //ako je registracija uspesno obavljena
